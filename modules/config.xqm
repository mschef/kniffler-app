...
(:
 ...
 :)
declare variable $config:default-template := "knifflertemplate_one.html";
        ...
        "output": function ($label) {
            switch ($label)
                case "de-DE"
                    return
                        <pb-i18n
                            key="langs.de">German</pb-i18n>
                case "en-EN"
                    return
                        <pb-i18n
                            key="langs.en">English</pb-i18n>
                case "nl-NL"
                    return
                        <pb-i18n
                            key="langs.nl">Dutch</pb-i18n>
                case "fr-FR"
                    return
                        <pb-i18n
                            key="langs.fr">French</pb-i18n>
                            case "ja-JA"
                    return
                        <pb-i18n
                            key="langs.ja">Japanese</pb-i18n>
                default return
                    $label
    }
},
...
map {
    "dimension": "placesent",
    "heading": "sender.location",
    "max": 5,
    "hierarchical": false()
},
map {
    "dimension": "senderOrg",
    "heading": "sender.orgName",
    "max": 5,
    "hierarchical": false()
},
map {
    "dimension": "senderPers",
    "heading": "sender.persName",
    "max": 5,
    "hierarchical": false()
},
map {
    "dimension": "daterecd",
    "heading": "addressee.date",
    "max": 5,
    "hierarchical": true()
},
map {
    "dimension": "placerecd",
    "heading": "addressee.location",
    "max": 5,
    "hierarchical": false()
},
map {
    "dimension": "addresseeOrg",
    "heading": "addressee.orgName",
    "max": 5,
    "hierarchical": false()
},
map {
    "dimension": "addresseePers",
    "heading": "addressee.persName",
    "max": 5,
    "hierarchical": false()
}
];
...
collection($config:data-root || "/knifflerSchema")/tei:TEI,
collection($config:data-root || "/register")/tei:TEI,
collection($config:data-root || "/documentation")/tei:TEI
)
;

declare variable $config:default-odd := "knifflerdesignodd.odd";
